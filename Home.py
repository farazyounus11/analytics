...
with col1:
    st.markdown("### I'm Faraz. I am a data science enthusiast. I first heard about statistics in high school. Ever since, I've always wanted to use machine learning to solve real world issues like optimal resources allocation, forecasting, text classification, and disease detection")
